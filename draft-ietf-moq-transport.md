...
to publish a new Group with a GroupID greater than the one specified in the message.

Relay publishers MUST aggregate GROUP_SYNC messages if the Largest Group in the request is
...
* Largest Group: The largest observed group in the track (either in SUBSCRIBE_OK or TRACK_STATUS_OK
or SUBSCRIBE_UPDATE_OK).
