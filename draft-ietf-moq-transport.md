...
* Wait For Next Group: A value of true specifies an open-ended subscription with objects from the beginning of the next group. A value of false specifies an open-ended subscription beginning from
